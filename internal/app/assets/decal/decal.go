...
import (
	...
	"github.com/FISTOFDARKNESS/Asset-Reuploader/internal/app/assets/shared/assetutils"
	"github.com/FISTOFDARKNESS/Asset-Reuploader/internal/app/assets/shared/clientutils"
	"github.com/FISTOFDARKNESS/Asset-Reuploader/internal/app/assets/shared/uploaderror"
	...
	"github.com/FISTOFDARKNESS/Asset-Reuploader/internal/atomicarray"
	"github.com/FISTOFDARKNESS/Asset-Reuploader/internal/retry"
	"github.com/FISTOFDARKNESS/Asset-Reuploader/internal/roblox/assetdelivery"
	"github.com/FISTOFDARKNESS/Asset-Reuploader/internal/roblox/develop"
	"github.com/FISTOFDARKNESS/Asset-Reuploader/internal/roblox/games"
	"github.com/FISTOFDARKNESS/Asset-Reuploader/internal/roblox/ide"
	"github.com/FISTOFDARKNESS/Asset-Reuploader/internal/shardedmap"
...
func Reupload(ctx *context.Context, r *request.Request) {
	...
	uploadAsset := func(wg *sync.WaitGroup, assetInfo *develop.AssetInfo, location string) {
		...
		uploadHandler, err := ide.NewUploadDecalHandler(client, assetInfo.Name, "", assetData, groupID)
		if err != nil {
		...
		res := <-uploadQueue.QueueTask(func() (int64, error) {
			return retry.Do(
				...
				func(try int) (int64, error) {
					...
					switch err {
					case ide.UploadDecalErrors.ErrNotLoggedIn:
						clientutils.GetNewCookie(ctx, r, "cookie expired")
					case ide.UploadDecalErrors.ErrInappropriateName:
